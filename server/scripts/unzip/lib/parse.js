...
Parse.prototype._readFile = function () {
  ...
  this._pullStream.pull(26, function (err, data) {
    ...
    return self._pullStream.pull(vars.fileNameLength, function (err, fileName) {
      ...
      var _charset = chardet.detect(fileName);
      fileName = iconv.decode(fileName, (_charset.confidence < 0.9) ? 'gb18030' : (_charset.encoding || 'utf8'));
      // console.log(_charset.encoding);
